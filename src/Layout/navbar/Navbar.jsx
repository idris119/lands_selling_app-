...
export default function Navbar() {
    return (
        <div>
            <nav className="navbar navbar-expand-lg bg-success mt-0 fixed-top">
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu bg-success">
                                    <li>
                                        <Link to="/Vehicles" className="dropdown-item text-white">Vehicles</Link>
                                    </li>
                                    <li>
                                        <Link to="/Lands" className="dropdown-item text-white">Lands</Link>
                                    </li>
                                    <li>
                                        <Link to="/Houses" className="dropdown-item text-white">Houses</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu bg-success">
                                    <li>
                                        <Link to="/Signup" className="dropdown-item text-white">Signup</Link>
                                    </li>
                                    <li>
                                        <Link to="/Login" className="dropdown-item text-white">Login</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="nav-item">
