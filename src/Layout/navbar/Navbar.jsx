...
//                                 <button className="nav-link active dropdown-toggle text-white" type="button" data-bs-toggle="dropdown" aria-expanded="false">Profile</button>
...
export default function Navbar() {
    return (
        <div>
            <nav className="navbar navbar-expand-lg bg-success mt-3">
                <div className="container">
                    <Link to="/" className="navbar-brand fw-bolder text-white"><h2>Property Sale</h2></Link>
                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                <button className="nav-link active dropdown-toggle text-white" type="button" data-bs-toggle="dropdown" aria-expanded="false">Profile</button>
                                <ul className="dropdown-menu bg-success">
                                    <li><Link to="/Profile" className="dropdown-item text-white">Profile</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
